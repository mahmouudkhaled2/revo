      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="flex justify-center gap-8 mt-12">
          ...
          <label className="relative cursor-pointer">
            ...
            />
            <div className={`w-64 p-4 border-2 rounded-lg transition-all ${
              selectedType === 'owner' 
              ...
              <div className="flex items-center gap-2">
                <div className={`w-5 h-5 border-2 rounded-sm flex items-center justify-center ${
                  selectedType === 'owner' ? 'border-[#F27141]' : 'border-gray-300'
                }`}>
                  {selectedType === 'owner' && (
                    <div className="w-3 h-3 bg-[#F27141]" />
                  )}
                </div>
                <span className="text-lg font-medium text-gray-900">Restaurant Account</span>
              </div>
            </div>
          </label>
          ...
          <label className="relative cursor-pointer">
            ...
            <div className={`w-64 p-4 border-2 rounded-lg transition-all ${
              ...
              <div className="flex items-center gap-2">
                <div className={`w-5 h-5 border-2 rounded-sm flex items-center justify-center ${
                  selectedType === 'user' ? 'border-[#F27141]' : 'border-gray-300'
                }`}>
                  {selectedType === 'user' && (
                    <div className="w-3 h-3 bg-[#F27141]" />
                  )}
                </div>
                <span className="text-lg font-medium text-gray-900">User Account</span>
              </div>
            </div>
          </label>
        </div>
