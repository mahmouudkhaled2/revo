...
export default function ForRestaurants() {
  ...
  const getAllRestaurants = async () => {
    try {
      ...
      const uniqueCuisines = [
        ...new Set(
          allRestaurants
            .map((restaurant) => restaurant.cuisineType?.toLowerCase())
            .filter(Boolean)
        ),
      ];
  ...
  const getFilteredRestaurants = useCallback(
    (searchTerm, cuisine, allRestaurants) => {
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  <img
                    src={getImageSrc(
                      restaurant.coverUrl,
                      "/public/assets/images/restaurant-placeholder.jpg"
                    )}
                    alt={restaurant.name}
